...
export default function TrustBadgeRow({ variant = "light", compact = false }: TrustBadgeRowProps) {
  return (
    <div
      ...
      {badges.map((badge) => (
        <div
          ...
          className={`flex items-center gap-2 cursor-default ${
            variant === "dark" ? "text-stone-300" : "text-text-muted"
